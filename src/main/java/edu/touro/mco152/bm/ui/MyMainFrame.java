...
public final class MyMainFrame extends javax.swing.JFrame {
     ...
     */
    public MyMainFrame(MyApp appInstance, GuiImplemented guiInstance) {
        this.appInstance = appInstance;
        this.guiInstance = guiInstance;
        initComponents();
        guiInstance.createChartPanel();
        mountPanel.setLayout(new BorderLayout());
        guiInstance.chartPanel.setSize(mountPanel.getSize());
        guiInstance.chartPanel.setSize(mountPanel.getWidth(), 200);
        mountPanel.add(guiInstance.chartPanel);
        totalTxProgBar.setStringPainted(true);
        totalTxProgBar.setValue(0);
        totalTxProgBar.setString("");
        setTitle(getTitle()+" "+appInstance.getVersion());
    ...
    private void initComponents() {
        ...
        runPanel = new edu.touro.mco152.bm.ui.MyRunPanel();
        guiInstance.runPanel = runPanel;
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        JOptionPane.showMessageDialog(guiInstance.mainFrame,
                "jDiskMark "+appInstance.getVersion(),"About...",JOptionPane.PLAIN_MESSAGE);
    ...
    private void clearRunsItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearRunsItemActionPerformed
        guiInstance.msg("Clearing previous runs.");
        appInstance.clearSavedRuns();
    ...
    private edu.touro.mco152.bm.ui.MyRunPanel runPanel;
